...
export default function CarLeasingForm() {
  ...
  useEffect(() => {
    ...
    const mockProducts = [
      ...
      {ID: 20, 'ยี่ห้อ': 'DECO', 'รุ่น': 'Superace', 'ราคา': 49900},
      {ID: 21, 'ยี่ห้อ': 'DECO', 'รุ่น': 'S45', 'ราคา': 93500},
      {ID: 22, 'ยี่ห้อ': 'DECO', 'รุ่น': 'Susu', 'ราคา': 72200},
      {ID: 23, 'ยี่ห้อ': 'DECO', 'รุ่น': 'Hannah', 'ราคา': 49900},
      {ID: 24, 'ยี่ห้อ': 'DECO', 'รุ่น': 'G-5 lite', 'ราคา': 48900},
      {ID: 25, 'ยี่ห้อ': 'DECO', 'รุ่น': 'Tanzo', 'ราคา': 78200}
    ];
